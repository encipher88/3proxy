...
cd /etc/3proxy/
wget --no-check-certificate https://github.com/encipher88/3proxy/raw/master/3proxy.cfg
chmod 600 /etc/3proxy/3proxy.cfg
mkdir /var/log/3proxy/
wget --no-check-certificate https://github.com/encipher88/3proxy/raw/master/.proxyauth
